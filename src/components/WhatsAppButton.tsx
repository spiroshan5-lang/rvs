    ...
    <AnimatePresence>
      {visible && (
        <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3.5 pointer-events-none">
          {/* Book Consultation Floating Pill Button */}
          <motion.a
            href="/contact"
            ...
            className="pointer-events-auto flex items-center gap-2 px-5 py-3.5 rounded-full shadow-2xl transition-all hover:scale-105 active:scale-95 cursor-pointer font-sans text-xs tracking-wider uppercase font-semibold border border-[var(--gold-border)]"
