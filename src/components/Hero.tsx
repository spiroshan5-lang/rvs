  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full max-w-[1920px] mx-auto rounded-[2.5rem] lg:rounded-[3.5rem] overflow-hidden border border-[#c9a86a]/15 shadow-2xl">
        ...
        {/* 2. Dark Gradient Overlay to ensure high text contrast and legibility */}
        ...
        <div className="absolute inset-0 z-20 w-full h-full flex flex-col justify-between">
          ...
          {/* Top Row: Logo on left, Button on right */}
          <div className="flex justify-between items-center w-full px-6 md:px-12 pt-6 md:pt-12">
            ...
            {/* Book Now Button (Visible on both desktop & mobile) */}
            <Link 
              href="/contact" 
          ...
          <div className="flex-1 flex flex-col justify-center max-w-4xl px-6 md:px-12 pt-8 md:pt-0">
          ...
          <div className="flex justify-between items-end w-full">
            ...
            {/* Left: Social Icons (WhatsApp and Phone) */}
            ...
            {/* Right: View our works card */}
            <Link 
              href="/gallery" 
              className="flex items-center space-x-3 md:space-x-6 px-5 py-4 md:px-10 md:py-8 bg-[#1f1005]/80 backdrop-blur-md border border-[#c9a86a]/35 border-r-0 border-b-0 rounded-tl-[2.5rem] md:rounded-tl-[3.5rem] group cursor-pointer hover:bg-[#3d2410]/95 transition-all text-[#F5F5F0]"
            >
