...
export default function StudioIntro() {
  return (
    <section 
      id="studio"
      className="transition-colors duration-300" style={{ background: 'var(--bg)', color: 'var(--fg)' }} 
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
        ...
        <div className="lg:col-span-3 flex flex-col space-y-6">
          ...
          >
            ...
            <span className="text-[10px] tracking-[0.3em] uppercase font-light text-[var(--gold)]">
              Our Philosophy
            </span>
          </motion.div>
        ...
        <div className="lg:col-span-9 flex flex-col space-y-12">
          ...
          >
            ...
            <span className="italic font-normal text-[var(--gold)]">Warmth, and Precision</span>
          </motion.h2>
          ...
          >
            <p className="text-base md:text-lg font-light leading-relaxed text-[var(--fg)]/80 tracking-wide">
            ...
            <div className="flex flex-col justify-between space-y-6">
              <p className="text-sm md:text-base font-light leading-relaxed text-[var(--fg)]/60 tracking-wide">
              ...
              <div className="pt-6 border-t border-[var(--gold-border)] flex items-center justify-start gap-12 md:gap-16">
                <div>
                  <h4 className="font-serif text-2xl font-light">12+</h4>
                  <p className="text-[9px] tracking-[0.2em] uppercase font-light text-[var(--fg)]/50">Years Crafting Space</p>
                </div>
                <div>
                  <h4 className="font-serif text-2xl font-light">180+</h4>
                  <p className="text-[9px] tracking-[0.2em] uppercase font-light text-[var(--fg)]/50">Trusted Clients</p>
                </div>
              </div>
            </div>
          </motion.div>
