    ...
    <div className=" min-h-screen text-[var(--fg)] flex flex-col justify-between transition-colors duration-300" style={{ background: 'var(--bg)', color: 'var(--fg)' }}>
      ...
      <main className="pt-32 flex-grow flex flex-col justify-center items-center overflow-hidden">
        <div className="max-w-7xl mx-auto w-full px-6 md:px-12 text-center mb-8">
          ...
          <p className="text-xs md:text-sm font-light text-[var(--fg)]/60 tracking-wider max-w-lg mx-auto leading-relaxed">
        ...
        <div className="w-full flex justify-center py-8 min-h-[40vh]">
          ...
          {loading && <div className="text-[var(--gold)] opacity-50 font-sans tracking-widest text-sm uppercase">Loading Gallery...</div>}
        </div>
      </main>
      <Footer />
    </div>
